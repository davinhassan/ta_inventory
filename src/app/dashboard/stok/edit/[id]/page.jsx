...
import { ArrowLeft, Save } from "lucide-react"; // Saya tambahkan ikon agar lebih cantik
...
function EditStokPage({ params }) {
  ...
  if (isLoading) {
    return <div className="p-8 text-white text-center">Sedang memuat data...</div>;
  }
  ...
  return (
    <AuthGuard allowedRoles={["PEMILIK", "MANAJER", "ADMIN"]}>
      ...
      <div className="p-4 md:p-8 w-full max-w-lg mx-auto">
        ...
        <h1 className="text-xl md:text-2xl font-bold mb-6 text-white">Edit Suku Cadang</h1>
        ...
        <div className="bg-gray-800 p-5 md:p-8 rounded-xl border border-gray-700 shadow-xl">
            ...
            <div>
                ...
                readOnly
                className="w-full bg-gray-900/50 border border-gray-600 rounded-lg px-3 py-3 text-gray-500 cursor-not-allowed text-sm md:text-base"
                />
            ...
            <div>
                ...
                required
                className="w-full bg-gray-900 border border-gray-600 rounded-lg px-3 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm md:text-base"
                />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full bg-gray-900 border border-green-600/50 rounded-lg px-3 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500 transition text-sm md:text-base"
                />
                </div>
            </div>
            ...
            <div>
                ...
                onChange={handleChange}
                required
                className="w-full bg-gray-900 border border-orange-600/50 rounded-lg px-3 py-3 text-white focus:outline-none focus:ring-2 focus:ring-orange-500 transition text-sm md:text-base"
                />
            ...
            <button
                type="submit"
                disabled={isSaving}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-lg mt-4 flex justify-center items-center gap-2 transition shadow-lg shadow-blue-900/20 active:scale-95 text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
                {isSaving ? "Menyimpan..." : (
                    <>
