    ...
    <AuthGuard allowedRoles={["MANAJER", "PEMILIK", "ADMIN"]}>
      ...
      <div className="p-4 md:p-8 w-full max-w-lg mx-auto">
        ...
        <form
          ...
          className="bg-card p-5 md:p-8 rounded-xl border border-border shadow-sm space-y-5"
        >
          {/* NAMA */}
          <div>
            <label className="block text-muted-foreground text-sm mb-1.5 flex items-center gap-2">
              <User size={16} /> Nama Lengkap
            </label>
            <input
              type="text"
              required
              className="w-full bg-background border border-input text-foreground p-3 rounded-lg focus:outline-none focus:border-blue-500 transition text-sm md:text-base placeholder:text-muted-foreground"
          ...
          <div>
            ...
            <div className="relative">
              <select
                className="w-full bg-background border border-input text-foreground p-3 rounded-lg focus:outline-none focus:border-blue-500 appearance-none cursor-pointer transition text-sm md:text-base"
                value={formData.role}
                onChange={(e) =>
